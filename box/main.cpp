...
int main(int argc, char* argv[])
{
    ...
    VART::MeshObject caixa;
    caixa.MakeBox(0,5,0,2,0,3);
    caixa.SetMaterial(VART::Material::PLASTIC_RED());
    ...
    VART::Point4D v0(0,2.001,0);
    VART::Point4D v1(0,3,1.5);
    VART::Point4D v2(0,2.001,3);
    VART::Point4D v3(5,2.001,0);
    VART::Point4D v4(5,3,1.5);
    VART::Point4D v5(5,2.001,3);
    ...
    telhado.SetVertices(vet);

    string face1="0 1 2";
    string face2="0 3 4 1";
    string face3="3 5 4";
    string face4="1 4 5 2";
    string face5="0 2 5 3";

    telhado.AddFace(face1.c_str());
    telhado.AddFace(face2.c_str());
    telhado.AddFace(face3.c_str());
    telhado.AddFace(face4.c_str());
    telhado.AddFace(face5.c_str());
